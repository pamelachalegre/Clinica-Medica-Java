...
public class Main {
    public static void main(String[] args) {
        ...
        Paciente p_Carol = new Paciente("Caroline", "111.222.333-44", "11.222.333-4", 'F', 18, "03/09/2005", "Avenida Maringá, 123", "44 99999-9999", "usuario@exemplo.com", true);
        ...
        sec.cadastrarPaciente(p_AnaPaula, listaPacientes); //indice 0
        sec.cadastrarPaciente(p_Carol, listaPacientes);//indice 1
